                ...
                #pragma omp parallel
                {
                    ...
                    for(unsigned int i=0;i<decMesh.getNumFaces();i++)
                    {
                        if(fit->inside==GridState::INSIDE)
                        {
                            ...
                            double vort1 = (vorticityField(iv1))/(maxVort*0.0015);
                            double vort2 = (vorticityField(iv2))/(maxVort*0.0015);
                            double vort3 = (vorticityField(iv3))/(maxVort*0.0015);
                            double vort4 = (vorticityField(iv4))/(maxVort*0.0015);
